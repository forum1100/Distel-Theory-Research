...
**Scientific status:** Partially formalized speculative research program.
...
- [Distel Theory](theory/DISTEL_THEORY.md)
- [DRO](theory/DRO.md)
- [DUCT](theory/DUCT.md)
- [Equation registry](equations/REGISTRY.md)
- [Equation lineage](equations/LINEAGE.md)
- [Simulation ledger](simulations/LEDGER.md)
- [Execution-evidence register](simulations/EXECUTION_EVIDENCE.md)
- [Applications](applications/README.md)
- [Research proposals](proposals/README.md)
- [Failures and rejected branches](FAILURES_AND_REJECTED_BRANCHES.md)
- [Failed-branch retest program](retests/README.md)
